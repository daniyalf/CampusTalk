...
namespace CampusChat.Controllers
{
    public class UniversitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UniversityID,Name,State")] University university)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UniversityID,Name,State")] University university)
        {
            if (ModelState.IsValid)
            {
